...
export function PageLinkPreviewCardLoading() {
	return (
		<div className="page-preview-card p-3 bg-background border border-border rounded-lg shadow-lg max-w-80">
			<div className="animate-pulse">
...
export function PageLinkPreviewCardError({ error }: { error: string }) {
	return (
		<div className="page-preview-card p-3 bg-background border border-red-200 rounded-lg shadow-lg max-w-80">
