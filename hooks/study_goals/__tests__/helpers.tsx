/**
 * Test helpers for Study Goals hooks
 *
 * Provides common utilities for testing Study Goals-related custom hooks:
...
// Mock study goal data
export const mockStudyGoal = {
	id: "goal-123",
	user_id: "user-123",
	title: "Test Goal",
