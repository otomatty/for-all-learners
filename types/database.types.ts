...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      extract_tiptap_text: { Args: { tiptap_json: Json }; Returns: string }
      ...
      review_card: {
        Args: { p_card_id: string; p_practice_mode?: string; p_quality: number }
        Returns: Json
      }
      search_all: {
      ...
      toggle_review_helpful: { Args: { p_review_id: string }; Returns: boolean }
